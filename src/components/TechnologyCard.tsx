...
const TechnologyCard = ({technology}: {technology: ITechnologyType}) => {
  return (
    <div className='p-5 border border-[#F1F5F9] rounded-2xl'>
        ...
        <button className='bg-black text-white font-sans text-sm py-2.5 px-21.5 rounded-lg cursor-pointer w-full mt-4'>Add to Stack</button>
