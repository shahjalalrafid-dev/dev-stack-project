...
const Explore = ({ technologyPromise }: Iprops) => {
    ...
    return (
        <section className="container mx-auto">
            <h2 className="font-inter text-4xl font-extrabold text-center lg:text-left">Explore the <span className="bg-linear-to-r from-[#EC4899] to-[#8B5CF6] text-transparent bg-clip-text">Technologies</span> </h2>
                    ...
                    <div className="grid lg:grid-cols-3 grid-cols-1 gap-5">

                        {
                            technologies.map((technology, index) => {
                                return (
                                    <TechnologyCard selected = {selected} setSelected = {setSelected} key={index} technology={technology} ></TechnologyCard>
                                )
                            })
                        }
